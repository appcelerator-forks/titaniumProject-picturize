		...
		success: function(data) {
			...
			for (var i=0;i<data.results.length;i++) {
				...
				var row = Ti.UI.createTableViewRow({
					...
					left:0,
					top:0,
					selectedBackgroundColor:"#fff100",
					_object:item 
				});
...
function createAssigmentList(args){
    ...
    Ti.API.log("createAssigmentList");
	Ti.API.log(args);
...
function createAssigmentMultiList(args){
	...
	Ti.API.log("createAssigmentMultiList");
	Ti.API.log(args);
...
//                    text:"Created: "+ moment(item.createdAt.iso).format('DD.MM.YYYY - h:mm'),
